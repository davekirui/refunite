...
public class AutoSync extends Activity{
	...
	public void onCreate(Bundle s)
	{
		...
		place(null);
	     ...
	     {
	    	Toast.makeText(getApplicationContext(), "Enable AutoSync",Toast.LENGTH_LONG).show(); 
	     }
	}
	...
	public void place(View v)
	{
		new AsyncTask<Integer,Integer,Boolean>()
		{
			...
			{
				pd=new ProgressDialog(AutoSync.this);
			...
			public void onPostExecute(Boolean result)
			{
				pd.hide();
			        ...
			        Toast.makeText(AutoSync.this,"Successfully Placed Sync",Toast.LENGTH_LONG).show() ; 
